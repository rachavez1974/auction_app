...
function SignUp(props) {
  ...
  return (
    <form id={'sign_up_form'} style={{border: '1px solid #ccc'}}>
      <div className="container">
        ...
        <input type="password" placeholder="Enter Password" value={password} onChange={handlePassword} name="psw" />
        <label htmlFor="psw-repeat"><b>Repeat Password</b></label>
        <input type="password" placeholder="Repeat Password" name="psw-repeat" value={confirmPassword} onChange={handleConfirmPassword} required />
        <label>
